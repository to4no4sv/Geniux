...
from geniux.errors import Error

class NeedsTrackIdOrTrackParameterNotBoth(Error, ValueError):
    def __init__(self) -> None:
        self.ru = "Необходимо указать `trackId` или `track`, но не оба типа."
        self.en = "You need to specify either `trackId`, or `track`, but not both types."