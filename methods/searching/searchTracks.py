...
class SearchTracks:
    @asyncFunction
    async def searchTracks(self, query: str, perPage: int = None, page: int = None, sort: Sort = None) -> Union[List[Track], Track, None]:
        searchResults = await self._search(query, "/song", perPage, page, sort)
