...
class GetTrackAnnotations:
    @asyncFunction
    async def getTrackAnnotations(self, id: int, perPage: int = None, page: int = None, textFormat: TextFormat = None) -> Union[List[Annotation], Annotation, None]:
        ...
        annotations = annotations.get("referents")
        if not annotations:
            return
