...
class GetArtistAlbums:
    @asyncFunction
    async def getArtistAlbums(self, id: int, perPage: int = None, page: int = None, sort: Sort = None) -> Union[List[Album], Album, None]:
        ...
        return self._finalizeResponse(albums, Album)